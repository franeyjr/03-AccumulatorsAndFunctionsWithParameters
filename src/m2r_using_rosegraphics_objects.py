...
#             objects have:
#                radius, outline_color, outline_thickness
#
#     f. What does a RoseWindow RENDER method do?
#            render draws on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When a window pops up this is how the window can stay open until the
#            user is ready to close it.
#
